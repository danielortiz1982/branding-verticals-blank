...
function bv_blank_scripts(){
	...
	wp_enqueue_style( 'bv-main-style', get_template_directory_uri() . '/assets/sass/css/aw-main.css' );
	...
	wp_enqueue_script('bv-main-js', get_template_directory_uri() . '/assets/js/dist/adw-bundle.js', array(), false, true);
